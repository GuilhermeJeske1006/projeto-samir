                ...
                @forelse ($funcionarios as $funcionario)
                    <flux:table.row>
                        ...
                        <flux:table.cell class="flex gap-2">
                            <flux:button size="sm" href="{{ route('funcionarios.edit', $funcionario) }}" wire:navigate icon="pencil" />
                            <flux:button size="sm" variant="danger" wire:click="delete({{ $funcionario->id }})" wire:confirm="Tem certeza que deseja excluir este funcionário?" icon="trash" />
                        </flux:table.cell>
                    </flux:table.row>
                @empty
                    <flux:table.row>
